...
function hfader(){
  ...
  function soundplayer(r, v, b, sc, sw, index) {
    background(r, v, b);
    stroke(sc);
    strokeWeight(sw);
    line(random(width), random(height), random(width), random(height));
  ...
  function soundplayer2(r, v, b, scr, scv, scb, sw, index) {
    background(r, v, b);
    stroke(scr, scv, scb);
    strokeWeight(sw);
    line(random(width), random(height), random(width), random(height));
  ...
  function keyPressed() {
    ...
    // var monkey = key.toLowerCase();

    // if (monkey == 'a') {
    //   soundplayer(77, 24, 49, 255, 5, 0);
    // }

    // if (monkey == 'z') {
    //   soundplayer2(255, 237, 12, 12, 78, 255, 14, 1);
    // }
